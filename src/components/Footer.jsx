...
function Footer() {
  return (
    <div className="w-full min-h-screen p-20 flex gap-5">
      <div className="w-1/2 h-[38vw] flex flex-col justify-between ">
        <div className="heading">
          <h1 className="text-[8vw] font-medium uppercase leading-none -mb-2">
            Eye-
          </h1>
          <h1 className="text-[8vw] font-medium uppercase leading-none -mb-2">
            Opening
      ...
      <div className="w-1/2">
        <h1 className="text-[5vw] font-medium uppercase leading-none mb-10 ">
          Presentations
        </h1>

        <div className="items flex items-center gap-32">
          <div className="w-1/2">
            <div className="mb-8">
            ...
            <div className="mb-8 w-2/3">
              ...
              <a href="">
                202-1965 W 4th Ave Vancouver, Canada 30 Chukarina St Lviv,
                Ukraine
              </a>
            </div>
            <div className="mb-8">
              <p className="mb-6">E:</p>
              <a href="#">hello@ochi.design</a>
            </div>
          </div>

          <div className="w-1/2">
            <p className="mb-6 mt-10">M:</p>
            <a className="block" href="#">
              HOME
            </a>
            <a className="block" href="#">
